...
class GazeboEnv:
    ...
    def __init__(self, launchfile, environment_dim):
        ...
        self.sub = rospy.Subscriber("robot2/front_laser/scan", LaserScan, self.Lidar)
        self.sub1 = rospy.Subscriber('/robot2/odom', Odometry, self.new0dom)
        # self.sub3 = rospy.Subscriber('/xy1', Point, self.path1)
        self.pub1 = rospy.Publisher('/robot2/cmd_vel', Twist, queue_size=1)
        self.speed = Twist()
        ...
        self.odom = rospy.Subscriber(
            "/robot1/odom", Odometry, self.odom_callback, queue_size=1
        )
    ...
    def step(self, action):
        ...
        self.length1 = distance
        diff_length = abs(self.length1 - self.length2)
        self.length3 += diff_length
        ...
        return state, reward, done, target, distance_r1r2, distance, self.length3, self.goal_x, self.goal_y
    ...
    def reset(self):
        ...
        while not position_ok:
            ...
            goal_x = [0.316, 0.02, 3.75, -2.4, 4.12]
            goal_y = [3.14, -2.77, 1.11, -0.52, 4.034]
            list1 = [0, 1, 2, 3, 4]
            Index_l = random.choice(list1)
            x = goal_x[Index_l]
            y = goal_y[Index_l]
            edist = math.dist([self.goal_x, self.goal_y], [x, y])
            position_ok = check_pos(x, y, edist)
    ...
    def change_goal(self):
        ...
        while not goal_ok:
            ...
            Index_l = random.choice(list1)
            self.goal_x = goal_x[Index_l]
            self.goal_y = goal_y[Index_l]
            self.goal_x = 1.2
            self.goal_y = 0.171
            edist = math.dist([self.goal_x, self.goal_y], [self.odom_x, self.odom_y])
            goal_ok = check_pos(self.goal_x, self.goal_y, edist)
    ...
    def publish_markers(self, action):
        ...
        marker = Marker()
        marker.header.frame_id = "robot1/odom"
        ...
        marker2 = Marker()
        marker2.header.frame_id = "robot1/odom"
        ...
        marker3 = Marker()
        marker3.header.frame_id = "robot1/odom"
