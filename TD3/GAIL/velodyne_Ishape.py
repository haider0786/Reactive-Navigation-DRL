...
def check_pos(x, y):
    ...
    if -3.0 > x > -7.2 and 0.5 > y > -1.5:
        goal_ok = False
    if 0.152 > x > 0.026 and 1.12 > y > -0.84:
        goal_ok = False
    if 4.08 > x > 3.23 and 3.72 > y > 2.25:
        goal_ok = False
    if -1.93 > x > -3.06 and 3.92 > y > 3.63:
        goal_ok = False
    if -2.51 > x > -3.41 and -3.50 > y > -4.18:
        goal_ok = False
    if -2.04 > x > -6.04 and 2.14 > y > -2.4:
        goal_ok = False
    if 5.95 > x > 1.97 and 1.97 > y > -2.37:
        goal_ok = False
