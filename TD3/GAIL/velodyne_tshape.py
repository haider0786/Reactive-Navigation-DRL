...
def check_pos(x, y):
    ...
    ## tshape update staircase
    if -0.68 > x > -2.18 and -4.27 > y > -4.39:
        goal_ok = False

    if 3.86 > x > 2.17 and -3.41 > y > -3.21:
        goal_ok = False

    if 2.17 > x > 1.62 and -4.01 > y > -3.21:
        goal_ok = False

    if 0.87 > x > -0.102 and -1.35 > y > -2.11:
        goal_ok = False

    if 0.57 > x > -0.62 and 2.29 > y > 1.03:
        goal_ok = False

    if -2.75 > x > -5.72 and 5.47 > y > -2.75:
        goal_ok = False

    if 5.50 > x > 2.58 and 5.47 > y > -1.57:
        goal_ok = False
